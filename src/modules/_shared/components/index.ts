export { DirectionSwitcher } from 'modules/_shared/components/direction-switcher/direction-switcher';
export { Loader } from 'modules/_shared/components/loader/loader';
