...
import { TransactionRegisterListHeader } from 'modules/document-flow/transaction-register/components/transaction-register-list-header/transaction-register-list-header';
import { TransactionRegisterListItem } from 'modules/document-flow/transaction-register/components/transaction-register-list-item/transaction-register-list-item';
