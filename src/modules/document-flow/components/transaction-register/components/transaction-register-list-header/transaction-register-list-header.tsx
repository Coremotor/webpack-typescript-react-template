...
import { useColumnsWidth } from 'modules/document-flow/components/transaction-register/hooks/use-columns-width';
import { useSetUnsetAllRegisters } from 'modules/document-flow/components/transaction-register/hooks/use-set-unset-all-registers';
